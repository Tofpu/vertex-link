...
- **Durability**:
  - Edge node: `MVStore` is used to store telemetries in disk in an event that it cannot communicate to the central server. Once a connection is restablished, the telemtries stored in disk are sent over and removed from disk.
